...
const currentWeatherDiv = document.querySelector(".current-waether")
	...
	navigator.geolocation.getCurrentPosition(
		...
		error => {
			if(error.code === error.PERMISSION_DENIED) {
				alert("Geolocation request denied. Please reset loation permission to grant access again.")
			}
		}
	);
}

locationButton.addEventListener("click", getUseCoordinates);
